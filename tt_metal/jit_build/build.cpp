...
#ifdef _WIN32
        // Native Windows toolchain binaries carry the .exe suffix. Keep it in gpp_ too, so
        // every spawn of the compiler (CreateProcessW, the version probe) names the real file.
        gxx += ".exe";
#endif
