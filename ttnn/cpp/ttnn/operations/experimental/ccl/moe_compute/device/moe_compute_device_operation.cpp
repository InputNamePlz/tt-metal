...
MoEComputeDeviceOperation::spec_return_value_t MoEComputeDeviceOperation::compute_output_specs(
    ...
    auto tilize_per_expert_total_tokens_shape =
        ttnn::Shape({num_cores, static_cast<uint32_t>(per_expert_total_tokens_row_elements)});
    ...
    const ttnn::MemoryConfig tilize_per_expert_total_tokens_sharded_memory_config = ttnn::MemoryConfig{
        ...
        tt::tt_metal::ShardSpec(
            shard_cores,
            {1, static_cast<uint32_t>(per_expert_total_tokens_row_elements)},
