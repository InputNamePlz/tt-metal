...
LlamaReduceScatterDeviceOperation::LlamaReduceScatterAdd::create_at_program_processing(
    ...
    */
    ...
    std::vector<uint32_t> reader_runtime_args = {
        static_cast<uint32_t>(cross_device_semaphore->address()), local_semaphore, false, false, 0, false, 0, 0, 0};
    ...
    for (auto core : all_cores) {
        std::vector<uint32_t> writer_runtime_args = {
            static_cast<uint32_t>(cross_device_semaphore->address()), local_semaphore, false, false, 0, 0, 0, 0};
