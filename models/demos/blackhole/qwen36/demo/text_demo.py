...
# "P100" is the harvested single-chip Blackhole (120 Tensix, 7x1 DRAM grid, no ethernet). It
# exposes the same 11x10 worker grid the single-device 9B path is tuned for, so it maps to (1, 1)
# exactly like P150 -- see determine_device_name() in tt_transformers/tt/model_config.py.
_MESH_SHAPE = {"P100": (1, 1), "P150": (1, 1), "P150x4": (1, 4), "P150x8": (1, 8)}.get(
